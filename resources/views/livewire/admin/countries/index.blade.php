                ...
                <form wire:submit.prevent="save" class="space-y-4">
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="flag" placeholder="DZ" class="w-full px-3.5 py-2.5 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500 text-center">
                        </div>
                    </div>
